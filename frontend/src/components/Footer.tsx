        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-footer-muted text-sm leading-relaxed">
              ...
              the world. Every piece tells a story.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-footer-muted text-sm">
              ...
              <li>
                <Link href="/products?category=pottery" className="hover:text-accent transition-colors">
                  Pottery
                </Link>
              </li>
              <li>
                <Link href="/products?category=textiles" className="hover:text-accent transition-colors">
                  Textiles
                </Link>
              </li>
              <li>
      ...
      <div className="border-t border-footer-border">
        <div className="container mx-auto py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-footer-muted text-sm">
            © {new Date().getFullYear()} Handicraft. Crafted with ❤️ for artisans.
          </p>
          <div className="flex gap-6 text-footer-muted text-sm">
